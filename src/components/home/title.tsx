...
const titleDefaultStyle = cn(
  "fixed p-4 left-0 right-0 z-10 bg-background/80 backdrop-blur font-title lg:bg-transparent lg:p-0 lg:left-auto lg:right-auto lg:relative lg:backdrop-blur-none lg:text-[48px]"
);
