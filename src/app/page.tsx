    ...
    <main className="relative">
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-2 opacity-70 mt-8">
          ...
          <p className="leading-loose">
            I have experience building real-time applications, e-commerces,
            social networks and real estate companies. You can find more about
            my past on my&nbsp;
          ...
          <p className="leading-loose">
            In my spare time, I like to write personal software. You can find
            more on my{" "}
            <Link href="https://github.com/joaoalberto-dev">Github</Link>.
          </p>
        </div>
      </div>
    </main>
